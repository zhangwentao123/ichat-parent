...
public class QrCodeUtils {
	 ...
	 * @param fileName 文件名称
	 */
	public static void generateQRCode(String content, String filePath, String fileName) throws WriterException, IOException {
		int width = 200;
		int height = 200;
		String format = "png";
	 ...
	 * @param filePath
	 */
	public static void resolveQRCode(String filePath) {
		try {
	 ...
	 * @param destPath 生成的目标路径
	 */
	public static void generateQRCodeWithLogo(String content, String logoPath, String destPath) {
		try {
			ImageIO.write(genBarcode(content, 200, 200, logoPath), "png", new File(destPath));
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static void main(String[] args) throws Exception {
		...
		// 生成二维码
		generateQRCode("http://dwz.cn/1KwflN", "D:/", "test.png");

		// 解析二维码
		resolveQRCode("D:/test.png");
		
		// 生成带logo的二维码
		generateQRCodeWithLogo("http://dwz.cn/1KwflN", "D:/4.jpg", "D:/new.png");
